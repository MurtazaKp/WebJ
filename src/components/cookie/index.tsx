...
// getting name of setting enabled
    const toggleSetting = (index:any) => {
      const newEnabledSettings = [...enabledSettings];
      newEnabledSettings[index] = !newEnabledSettings[index];
      setEnabledSettings(newEnabledSettings);

      const checkedSettingNames = settings
      .filter((setting, i) => newEnabledSettings[i])
      .map((setting) => setting.name);
    setCheckedSettings(checkedSettingNames);
...
//  Accepting all cookies function
...
// useEffect(() => {
    ...
    // },[]);
// Accepting Custom cookie function
        ...
        <div className="relative z-50 flex justify-center items-center ">
            ...
            <div id="menu" className=" w-full h-full flex justify-center items-center bg-gray-900 bg-opacity-80 top-0  fixed sticky-0">
                ...
                {isCookie && (
                    <div className=" md:w-auto relative flex flex-col justify-center z-50 items-center bg-white py-10 sm:py-[26px] lg:py-[26px] px-4 sm:px-10">
                        ...
                        <div className="mt-6 sm:mt-12">
                            <h1 role="main" className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9 text-center text-gray-800">
                                {cookieData.cookieTitle}
                            </h1>
                        </div>
                        <div className="mt">
                            <p className="mt-6 sm:w-80 text-base leading-7 text-center text-gray-800">{cookieData.cookieDescription}</p>
                        </div>
                   ...
                   {isSetting && (
                <div className="md:w-[400px] relative z-50 items-start bg-white sm:py-[19px] sm:pb-[19px] sm:px-12 lg:py-[31px] lg:pb-[30px] px-4 lg:px-12">
                    <div className="py-16 px-5 sm:py-0 sm:px-0  flex flex-col justify-center gap-4  sm:gap-10">
                        <h2 className="text-2xl">Cookie Settings</h2>
                        
                        {cookieData.customSetting.map((setting:any, index:number) => (
                            <div key={index} className="flex justify-between gap-20 items-center w-full">
                                {setting.customTilte} 
                ...
                <label className="inline-flex relative items-center cursor-pointer">
                    ...
                    ></div>
                        ...
                        <span className="flex gap-4">
                            <button
                                onClick={customCookies}
                                className="w-full sm:w-auto text-base leading-4 text-center text-white py-2 px-5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-gray-800 hover:bg-black "
                            >
                                {cookieData.customSettingButtons[0].customSettingButton}
                            </button>
                            <button
                                onClick={handleBack}
                                className="w-full sm:w-auto text-base leading-4 text-center text-white py-2 px-5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-gray-800 hover:bg-black "
                            >
                                {cookieData.customSettingButtons[1].customSettingButton}
                            </button>
                        </span>
                        <button
                            onClick={handleClose}
